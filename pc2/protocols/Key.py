...
class Key:
    ...
    def send_keys(self, port):
        ...
        send_keys(json.dumps(msg), IP[self.id], MAC[self.id], 'eth1')

        logging.debug('Send keys successful')
...
class DBKey(Key):
    ...
    def send_db_key(self):
        ...
        """
        send_keys(self.public_key.exportKey().decode(), '172.16.104.15', '98:98:98:44:44:44', 'eth2')
